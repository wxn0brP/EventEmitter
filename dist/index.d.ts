...
type EventArgs<T extends EventMap, K extends EventName<T>> = K extends keyof T ? Parameters<T[K]> : any[];
export declare class VEE<T extends EventMap = {}> {
     ...
     */
    on<K extends EventName<T>>(event: K, listener: (...args: EventArgs<T, K>) => void): void;
    /**
     * Registers a one-time event listener
     * @param {K} event - event name
     * @param {Function} listener - function to be called once
     */
    once<K extends EventName<T>>(event: K, listener: (...args: EventArgs<T, K>) => void): void;
    /**
     * Removes an event listener.
     * @param {K} event - event name
     * @param {Function} listener - listener to remove
     */
    off<K extends EventName<T>>(event: K, listener: (...args: EventArgs<T, K>) => void): void;
    /**
     * Emits an event
     * @param {K} event - event name
